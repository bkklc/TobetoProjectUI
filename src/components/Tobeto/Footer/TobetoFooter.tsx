      ...
      <div className="container">
        <div className="row justify-content-between pb-20 border-info border-bottom">
            ...
            <ul className="list-unstyled">
              <li className="mb-3">
                <Link
                  target="_blank"
                  className="small text-white text-decoration-none"
                  to="/yasal-metinler/tobeto-uyelik-sozlesmesi"
                >
              ...
              <li className="mb-3">
                <Link
                  target="_blank"
                  className="small text-white text-decoration-none"
                  to="/yasal-metinler/kvkk-aydinlatma-metni"
                >
              ...
              <li className="mb-3">
                <Link
                  target="_blank"
                  className="small text-white text-decoration-none"
                  to="/yasal-metinler/tobeto-cerez-politikasi"
                >
                  Çerez Politikası
                </Link>
              </li>
          ...
          <div className="col-6 col-md-6 col-lg-4 mb-8 mb-lg-0">
            ...
            <ul className="list-unstyled">
              <li className="mb-3">
                <Link className="small text-white text-decoration-none" to="">
