...
import CatalogCard from "../../Platform/CatalogCard/CatalogCard";
import CatalogFilter from "../../Platform/CatalogFilter/CatalogFilter";
...
const HomePageCatalog = () => {
  return (
    ...
    <div className='pt-1 '>
      <div className="search-section container-fluid mt-40">
        <Container>
          <Row>
