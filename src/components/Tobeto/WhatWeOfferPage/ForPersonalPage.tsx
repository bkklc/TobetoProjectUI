...
const ForPersonalPage = () => {
  return (
    <main className="bg-front-dark">
      <Container>
        <div className=" col-12 py-4 px-lg-40 px-md-20 px-sm-2 pt-40">
        ...
        >
          <div className="container text-center">
            <div className="mw-5xl mx-auto position-relative">
              ...
              <h1 className="text-white" style={{ fontSize: "3em !important" }}>
              ...
              <p className="text-white my-8">
                <a href="http://www.codecademy.com"> Codecademy</a> iş birliği
                ile, fark yaratmak senin elinde!
              </p>
              <a
                href="/kayit-ol"
      ...
      <div className=" gradient-line2 mt-5" id="profesyonel-bir-yonetici"></div>
