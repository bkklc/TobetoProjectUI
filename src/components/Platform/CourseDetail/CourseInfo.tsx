                          ...
                          >
                            <div className="ant-space-item" style={{}}>
                              <div className="activity-score text-white background-blue">
                                <span className="account-balance">35.2</span>{" "}
                                PUAN
                              </div>
                            </div>
                            <div className="ant-space-item" style={{}} />
                      ...
                      >
                        ...
                        >
                          <div className="tabs-nav ">
                            <span className="tabs-nav-title">İçerik</span>
                          </div>
                        </div>
                      </div>
                      <div data-node-key="about" className="ant-tabs-tab">
                        <div
                          role="tab"
                          aria-selected="false"
                          className="ant-tabs-tab-btn"
                        ...
                        >
                          <div className="tabs-nav ">
                            <span className="tabs-nav-title">Hakkında</span>
                          </div>
                        </div>
                      </div>
                      <div
                                ...
                                <div>
                                  ...
                                  >
                                    <video
                                      ...
                                      tabIndex={-1}
                                      role="application"
                                      src="blob:https://lms.tobeto.com/1c9a3c67-273b-430a-a4ff-c671914b2916"
