          ...
          <div className="cv-info cv-padding">
            <div className="info-box">
              ...
              <div className="info-text">
                ...
                <span className="text">{responseData && (responseData.firstName + " " + responseData.lastName)}</span>
              </div>
            </div>
            <div className="info-box">
              ...
              <div className="info-text">
                ...
                <span className="text">{responseData && (responseData.birthDate.split('T')[0])}</span>
              </div>
            </div>
            <div className="info-box">
              ...
              <div className="info-text">
                ...
                <span className="text">{responseData && (responseData.email)}</span>
              </div>
            </div>
            <div className="info-box">
              ...
              <div className="info-text">
                ...
                <span className="text">{responseData && (responseData.phoneNumber)}</span>
              </div>
            </div>
          </div>
        </div>
